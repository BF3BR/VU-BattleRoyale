...
function ManDownModifier:OnSoldierBlueprintLoaded(p_SoldierBlueprint)
    ...
    s_SoldierEntityData.maxHealth = 300
    ...
    for i = #p_SoldierBlueprint.eventConnections, 1, -1 do
        if p_SoldierBlueprint.eventConnections[i].source:Is("SoldierEntityData") and
            p_SoldierBlueprint.eventConnections[i].target:Is("PlayerFilterEntityData") then
        ...
        elseif p_SoldierBlueprint.eventConnections[i].target.instanceGuid == Guid("9DF212F6-73C1-4218-9110-2090EE95F730") then
            ...
            p_SoldierBlueprint.eventConnections:erase(i)
        elseif p_SoldierBlueprint.eventConnections[i].source:Is("SoldierEntityData") and
            p_SoldierBlueprint.eventConnections[i].target.instanceGuid == Guid("8B5295FF-8770-4587-B436-1F2E71F97F35") then
    ...
    for i = #p_SoldierBlueprint.propertyConnections, 1, -1 do
        if p_SoldierBlueprint.propertyConnections[i].source.instanceGuid == Guid("9DF212F6-73C1-4218-9110-2090EE95F730") or
            p_SoldierBlueprint.propertyConnections[i].target.instanceGuid == Guid("9DF212F6-73C1-4218-9110-2090EE95F730") then 
            p_SoldierBlueprint.propertyConnections:erase(i)
        end
    end
    ...
    s_InputRestrictionEntityData.selectWeapon9 = false
    ...
    local s_EntityInteractionComponentData = EntityInteractionComponentData(s_Partition:FindInstance(Guid("9C51D42E-94F9-424A-89D2-CBBCA32F1BCE")))
    s_EntityInteractionComponentData:MakeWritable()
    s_EntityInteractionComponentData.allowInteractionWithSoldiers = true
    ...
    s_VeniceSoldierHealthModuleData.manDownStateTime = 60.0
