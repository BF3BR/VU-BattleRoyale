...
function RemoveAutoTriggerVO:DeregisterCallbacks()
	m_AutoTriggersMP_VoiceOverLogicAsset:Deregister()
	m_ComRose_VoiceOverLogicAsset:Deregister()
end
