...
function LootPointHelper:PrintPointsAsLinearTransforms()
	...
	for _, l_Point in pairs(self.m_Points) do
		s_Result = s_Result.."LinearTransform("..
			"Vec3"..string.gsub(tostring(l_Point.left),"000000","0")..
			", Vec3"..string.gsub(tostring(l_Point.up),"000000","0")..
			", Vec3"..string.gsub(tostring(l_Point.forward),"000000","0")..
			", Vec3"..tostring(l_Point.trans).."), "
	end
